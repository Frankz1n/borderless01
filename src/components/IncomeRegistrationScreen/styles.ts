...
// Exporting exactly the same layout frames but renaming context specific ones if needed
...
export const SubmitButton = styled(motion.button)`
  background: linear-gradient(135deg, #10b981 0%, #059669 100%); /* Greenish accent for INCOMES now */
  color: white;
  border: none;
  border-radius: 12px;
  padding: 1rem;
